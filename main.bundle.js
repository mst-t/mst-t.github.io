...
var WorkService = (function () {
    function WorkService() {
        this.works = [
            new __WEBPACK_IMPORTED_MODULE_1__work__["a" /* Work */]("Google Feed Reader", "This application is based on a Udacity project that tests existing features\n       written in JavaScript and jQuery using Jasmine.\n       I rebuilt this application in the test-driven method.\n       After writing the tests using Jasmine, I implemented the functionalities using AngularJs.", "./assets/images/feedReader.png", "https://github.com/mst-t/google-feed-reader", "http://artist-clamps-52452.netlify.com", ["AngularJs", "Jasmine", "Promise", "jQuery", "Ajax", "Test-driven Development", "Google Feed Reader API"]),
            new __WEBPACK_IMPORTED_MODULE_1__work__["a" /* Work */]("Favorite Article Clipper", "This application, named \"Favorii\", allows users to keep a favorite article with a short summary in their local storage.\n         Once users enter url and press \"save\" or the enter key, the title, url, and a short sumarry are saved.\n         The front-end is AngularJs and the back-end is Node. In addition, AYLIEN API is used to get a summary of articles.", "./assets/images/favorii.png", "https://github.com/mst-t/favorii", "https://sheltered-savannah-96980.herokuapp.com/", ["AngularJs(v-1.6)", "Express", "Node.js", "Bootstrap", "AYLIEN API"]),
